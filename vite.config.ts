...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      // Never run the SW in dev / Lovable preview iframe
      ...
      manifest: {
        ...
        description:
          "Daily Material Receipt & GRN management with OCR + SAP integration.",
        theme_color: "#0F172A",
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Supabase REST + edge functions: prefer network, fall back to cache
